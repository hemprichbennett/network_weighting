# functions for creating and aggregating networks: either for the R shiny doc accompanying this code 
# that lets the user play, or the actual analyses themselves.
